...
context = """Назначение: Основная роль этого агента заключается в помощи пользователям, предоставляя точную информацию 
            о статистике мирового населения и деталях о стране. """
